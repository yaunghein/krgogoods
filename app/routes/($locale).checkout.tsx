...
function Left({
  ...
  return (
    <div className="p-4 sm:p-10">
      <div className="font-bold text-xs sm:text-base mb-2 sm:mb-4 ml-2 sm:ml-4 uppercase">
        Contact
      </div>
      <input
        type="email"
      ...
      />
      <div className="font-bold text-xs sm:text-base mb-2 sm:mb-4 mt-4 ml-2 sm:ml-4 uppercase">
        Delivery
      </div>
      <input
        type="text"
